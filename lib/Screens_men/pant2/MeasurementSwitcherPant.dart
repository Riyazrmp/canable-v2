...
class MeasurementSwitcherPant extends StatefulWidget {
  final int backPrice;
  final int neckPrice;
  ...
  MeasurementSwitcherPant(
      ...
      this.backD});
  @override
  _MeasurementSwitcherPantState createState() =>
      _MeasurementSwitcherPantState();
}

class _MeasurementSwitcherPantState extends State<MeasurementSwitcherPant> {
