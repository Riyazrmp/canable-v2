...
import 'pantPlanSelect.dart';

class PantForm extends StatefulWidget {
  final int backPrice;
  final int neckPrice;
  final int cutPrice;
  final String neckD;
  ...
  @override
  _PantFormState createState() => _PantFormState();
}
...
class _PantFormState extends State<PantForm> {
  @override
  void initState() {
    _updateAppbar();
    // play();
  ...
  uploadData() async {
    ...
    if (topMeasurement.docs.isNotEmpty) {
      ...
      Navigator.push(context, CupertinoPageRoute(builder: (context) {
        return MeasurementSwitcherBlouse(
          cutPrice: widget.cutPrice,
          basicPrice: priceResult.data()['basicBlouse'],
          premiumPrice: priceResult.data()['premiumBlouse'],
    ...
    return ListView(
      ...
      children: [
        ...
        ListTile(
          ...
          title:
              Text(DemoLocalizations.of(context).getTranslatedValue("blouse"),
                  style: TextStyle(
                    fontFamily: 'CodeProlight',
                    color: Colors.black,
                    fontSize: 22,
        ...
        Align(
          ...
          child: Padding(
            ...
            child: Text(
                DemoLocalizations.of(context)
                    .getTranslatedValue("notes_text_blouse"),
                style: TextStyle(
                  fontFamily: 'CodeProlight',
                  color: Colors.black,
                  fontSize: 16,
