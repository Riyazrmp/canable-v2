...
class PantAddress extends StatefulWidget {
  final int backPrice;
  final int neckPrice;
  ...
  @override
  _PantAddressState createState() => _PantAddressState();
}

class _PantAddressState extends State<PantAddress> {
  ...
  orderPlacement() async {
    ...
    await firestore
      ...
      'damanHeight': widget.cutHeight,
      'sleevesImage': widget.backD,
      'sleevesPrice': widget.backPrice,
      'notes': widget.notesData,
      'fabricImage': widget.fabricImage,
      'status': 'In Progress',
      'neckName': widget.neckN,
      'sleevesName': widget.backN,
      'damanName': widget.cutN,
      'userId': user.uid,
