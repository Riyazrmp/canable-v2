...
import 'package:canable_user/Screens_men/PantShirt/PantShirtMeasurement.dart';
import 'package:canable_user/Screens_men/PantShirt/PantShirtPlanSelect.dart';
...
class PantShirtForm extends StatefulWidget {
  final int sleevesPrice;
  final int neckPrice;
  final int damanPrice;
  final int frontPrice;
  final String frontD;
  final String frontN;
  ...
  PantShirtForm(
      ...
      this.sleevesLengthD});
  @override
  _PantShirtFormState createState() => _PantShirtFormState();
}
...
class _PantShirtFormState extends State<PantShirtForm> {
  @override
  void initState() {
    // play();
    _updateAppbar();
  ...
  uploadData() async {
    ...
    if (topMeasurement.docs.isNotEmpty) {
      ...
      Navigator.push(context, CupertinoPageRoute(builder: (context) {
        return PantShirtMeasurement(
          frontPrice: widget.frontPrice,
          frontD: widget.frontD,
          frontN:widget.frontN,
