...
class PantShirtAddress extends StatefulWidget {
  ...
  PantShirtAddress(
      ...
      this.sleevesLengthD});
  @override
  _PantShirtAddressState createState() => _PantShirtAddressState();
}

class _PantShirtAddressState extends State<PantShirtAddress> {
  ...
  orderPlacement() async {
    ...
    await firestore
      ...
      'orderId': fileName,
      'city': controller3.text,
      'frontName':widget.frontN,
      'frontImage':widget.frontD,
