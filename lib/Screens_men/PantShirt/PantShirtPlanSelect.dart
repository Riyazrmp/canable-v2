...
import 'package:canable_user/Screens_men/PantShirt/PantShirtSummary.dart';
...
class PantShirtPlanSelect extends StatefulWidget {
  ...
  PantShirtPlanSelect(
      ...
      this.sleevesLengthD});
  @override
  _PantShirtPlanSelectState createState() => _PantShirtPlanSelectState();
}

class _PantShirtPlanSelectState extends State<PantShirtPlanSelect> {
  bool isPremium = true;
  int price = 0;
  int basicPrice = 0;
  int premiumPrice = 0;
