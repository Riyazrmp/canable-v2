...
class PantShirtMeasurement extends StatefulWidget {
  ...
  PantShirtMeasurement(
      ...
      this.sleevesLengthD});
  @override
  _PantShirtMeasurementState createState() =>
      _PantShirtMeasurementState();
}

class _PantShirtMeasurementState extends State<PantShirtMeasurement> {
      ...
      appBar: CupertinoNavigationBar(
        trailing: CupertinoButton(
          ...
          frontN:widget.frontN,
                sleeveAstar: widget.sleevesAstar,
