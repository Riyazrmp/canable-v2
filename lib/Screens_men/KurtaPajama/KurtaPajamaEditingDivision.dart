...
import 'package:canable_user/Screens_men/KurtaPajama/KurtaPajamaForm.dart';
...
class KurtaPajamaEditingDivision extends StatefulWidget {
  final String languageCode;
  KurtaPajamaEditingDivision(this.languageCode);
  @override
  _KurtaPajamaEditingDivisionState createState() => _KurtaPajamaEditingDivisionState();
}

class _KurtaPajamaEditingDivisionState extends State<KurtaPajamaEditingDivision> {
  ...
  loadSleevesData() async {
    ...
    setState(() {
      ...
      sleevesName =
          sleevesFullLength.docs[0]['${widget.languageCode}name'];
