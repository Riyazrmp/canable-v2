...
import 'package:canable_user/Screens_men/KurtaPajama/KurtaPajamSummary.dart';
...
class KurtaPajamaPlanSelect extends StatefulWidget {
  ...
  KurtaPajamaPlanSelect(
      ...
      this.sleevesLengthD});
  @override
  _KurtaPajamaPlanSelectState createState() => _KurtaPajamaPlanSelectState();
}

class _KurtaPajamaPlanSelectState extends State<KurtaPajamaPlanSelect> {
  bool isPremium = true;
  int price = 0;
  int basicPrice = 0;
  int premiumPrice = 0;
