...
class KurtaPajamaAddress extends StatefulWidget {
  ...
  KurtaPajamaAddress(
      ...
      this.sleevesLengthD});
  @override
  _KurtaPajamaAddressState createState() => _KurtaPajamaAddressState();
}

class _KurtaPajamaAddressState extends State<KurtaPajamaAddress> {
  ...
  orderPlacement() async {
    ...
    await firestore
      ...
      'type': 'garara',
      'typeDisplay': widget.bottomN + ' top',
      'name': controller.text,
      'phone': controller1.text,
      'address': controller2.text,
      'orderId': fileName,
