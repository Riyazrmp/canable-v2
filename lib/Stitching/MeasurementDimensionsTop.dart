                        ...
                        children: <Widget>[
                          Text('baazu',
                              style: TextStyle(
                                  ...
                                  fontWeight: FontWeight.w800,
                                  fontSize: 22)),
                          Text(widget.snapshot['baazu'].toString(),
                              style: TextStyle(
                                  fontFamily: 'CodeProlight', fontSize: 22)),
                        ],
                      ),
                        ...
                        children: <Widget>[
                          Text('mori',
                              style: TextStyle(
                                  ...
                                  fontWeight: FontWeight.w800,
                                  fontSize: 22)),
                          Text(widget.snapshot['mori'].toString(),
                              style: TextStyle(
                                  fontFamily: 'CodeProlight', fontSize: 22)),
                        ],
                      ),
                        ...
                        children: <Widget>[
                          Text('teera',
                              style: TextStyle(
                                  ...
                                  fontWeight: FontWeight.w800,
                                  fontSize: 22)),
                          Text(widget.snapshot['teera'].toString(),
                              style: TextStyle(
                                  fontFamily: 'CodeProlight', fontSize: 22)),
                        ],
                      ),
                        ...
                        children: <Widget>[
                          Text('gala',
                              style: TextStyle(
                                  ...
                                  fontWeight: FontWeight.w800,
                                  fontSize: 22)),
                          Text(widget.snapshot['gala'].toString(),
                              style: TextStyle(
                                  fontFamily: 'CodeProlight', fontSize: 22)),
                        ],
                      ),
                        ...
                        children: <Widget>[
                          Text('Daman',
                              style: TextStyle(
                                  ...
                                  fontWeight: FontWeight.w800,
                                  fontSize: 22)),
                          Text(widget.snapshot['daman'].toString(),
                              style: TextStyle(
                                  fontFamily: 'CodeProlight', fontSize: 22)),
                        ],
                      ),
