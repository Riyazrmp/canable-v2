...
class Address_SS extends StatefulWidget {
  ...
  Address_SS(
      ...
      this.sleevesLengthD});
  @override
  _Address_SSState createState() => _Address_SSState();
}

class _Address_SSState extends State<Address_SS> {
  ...
  orderPlacement() async {
    ...
    await firestore
      ...
      'type': 'salwarSuit',
      'typeDisplay': widget.bottomN + ' Suit',
      'name': controller.text,
      'phone': controller1.text,
      'address': controller2.text,
      'orderId': fileName,
