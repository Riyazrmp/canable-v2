...
import 'SalwarSuitEdititingScreen.dart';
import 'Summary_SS.dart';

class PlanSelect0 extends StatefulWidget {
  ...
  PlanSelect0(
      ...
      this.sleevesLengthD});
  @override
  _PlanSelect0State createState() => _PlanSelect0State();
}

class _PlanSelect0State extends State<PlanSelect0> {
  bool isPremium = true;
  int price = 0;
  int basicPrice = 0;
  int premiumPrice = 0;
