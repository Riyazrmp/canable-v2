...
class Summary_SS extends StatefulWidget {
  ...
  Summary_SS(
      ...
      this.sleevesLengthD});
  @override
  _Summary_SSState createState() => _Summary_SSState();
}

class _Summary_SSState extends State<Summary_SS> {
