...
class AlterationInfo extends StatefulWidget {
  ...
  @override
  _AlterationInfoState createState() => _AlterationInfoState();
}

class _AlterationInfoState extends State<AlterationInfo> {
