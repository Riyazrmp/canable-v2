...
import 'SendYourDesignSummary.dart';
import 'measurementSwitcher.dart';

class SS_2 extends StatefulWidget {
  ...
  SS_2(
      ...
      this.sleevesLengthD});
  @override
  _SS_2State createState() => _SS_2State();
}
...
class _SS_2State extends State<SS_2> {
  @override
  void initState() {
    // play();
    _updateAppbar();
    ...
    if (topMeasurement.docs.isNotEmpty) {
      ...
      Navigator.push(context, CupertinoPageRoute(builder: (context) {
        return MeasurementSwitcherSS(
          ...
          basicPrice: priceResult.data()['basicSS'],
          premiumPrice: priceResult.data()['premiumSS'],
          f1b: priceResult.data()['f1b'],
          isMeasurementProvider: isMeasurementSelected,
      ...
      Navigator.push(context, CupertinoPageRoute(builder: (context) {
        return PlanSelect0(
          ...
          f1p: priceResult.data()['f1p'],
          f2b: priceResult.data()['f2b'],
          isMeasurementSelected: isMeasurementSelected,
          f2p: priceResult.data()['f2p'],
          f3b: priceResult.data()['f3b'],
          f3p: priceResult.data()['f3p'],
          f1bdays: priceResult.data()['f1bdays'],
    ...
    return ListView(
      ...
      children: [
        ...
        ListTile(
          ...
          title:
              Text(DemoLocalizations.of(context).getTranslatedValue("patch?"),
                  style: TextStyle(
                    fontFamily: 'CodeProlight',
                    color: Colors.black,
                    fontSize: 18,
