...
import 'package:canable_user/Screens/Lehenga/MeasurementSwitcherLehenga.dart';
...
import 'LehengaPlanSelect.dart';

class LehengaForm extends StatefulWidget {
  ...
  LehengaForm(
      ...
      this.sleevesLengthD});
  @override
  _LehengaFormState createState() => _LehengaFormState();
}
...
class _LehengaFormState extends State<LehengaForm> {
  @override
  void initState() {
    // play();
    _updateAppbar();
  ...
  uploadData() async {
    ...
    if (topMeasurement.docs.isNotEmpty) {
      ...
      Navigator.push(context, CupertinoPageRoute(builder: (context) {
        return MeasurementSwitcherLehenga(
          ...
          basicPrice: priceResult.data()['basicLehenga'],
          premiumPrice: priceResult.data()['premiumLehenga'],
    ...
    return ListView(
      ...
      children: [
        ...
        ListTile(
          ...
          title: Text(
              DemoLocalizations.of(context)
                  .getTranslatedValue("patch?_lehenga"),
              style: TextStyle(
                fontFamily: 'CodeProlight',
                color: Colors.black,
                fontSize: 18,
        ...
        Align(
          ...
          child: Padding(
            ...
            child: Text(
                DemoLocalizations.of(context)
                    .getTranslatedValue("notes_text_lehenga"),
                style: TextStyle(
                  fontFamily: 'CodeProlight',
                  color: Colors.black,
                  fontSize: 16,
