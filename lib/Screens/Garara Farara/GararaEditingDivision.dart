...
class GararaEditingDivision extends StatefulWidget {
  final String languageCode;
  GararaEditingDivision(this.languageCode);
  @override
  _GararaEditingDivisionState createState() => _GararaEditingDivisionState();
}

class _GararaEditingDivisionState extends State<GararaEditingDivision> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CupertinoNavigationBar(
        ...
        backgroundColor: Colors.white,
        middle: Text(
          DemoLocalizations.of(context).getTranslatedValue("garara"),
          style: TextStyle(
              fontFamily: 'CodeProlight',
              fontWeight: FontWeight.w800,
              fontSize: 24),
