...
class GararaPlanSelect extends StatefulWidget {
  ...
  GararaPlanSelect(
      ...
      this.sleevesLengthD});
  @override
  _GararaPlanSelectState createState() => _GararaPlanSelectState();
}

class _GararaPlanSelectState extends State<GararaPlanSelect> {
  bool isPremium = true;
  int price = 0;
  int basicPrice = 0;
  int premiumPrice = 0;
