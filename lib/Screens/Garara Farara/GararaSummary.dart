...
import 'GararaAddress.dart';

class GararaSummary extends StatefulWidget {
  ...
  GararaSummary(
      ...
      this.sleevesLengthD});
  @override
  _GararaSummaryState createState() => _GararaSummaryState();
}

class _GararaSummaryState extends State<GararaSummary> {
