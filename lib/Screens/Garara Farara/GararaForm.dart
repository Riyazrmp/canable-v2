...
class GararaForm extends StatefulWidget {
  ...
  GararaForm(
      ...
      this.sleevesLengthD});
  @override
  _GararaFormState createState() => _GararaFormState();
}
...
class _GararaFormState extends State<GararaForm> {
  @override
  void initState() {
    // play();
    _updateAppbar();
  ...
  uploadData() async {
    ...
    if (topMeasurement.docs.isNotEmpty) {
      ...
      Navigator.push(context, CupertinoPageRoute(builder: (context) {
        return MeasurementSwitcherGarara(
