...
class FrockEditingDivision extends StatefulWidget {
  final String languageCode;
  FrockEditingDivision(this.languageCode);
  @override
  _FrockEditingDivisionState createState() => _FrockEditingDivisionState();
}

class _FrockEditingDivisionState extends State<FrockEditingDivision> {
                    ...
                    ghairSnapshots != null
                        ? Padding(
                            ...
                            child: Material(
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  showGhairSheet(context, damanSnapshots);
                                },
                                child: Container(
                                    decoration: BoxDecoration(
                                      color: Colors.grey[100],
