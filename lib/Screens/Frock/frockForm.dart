...
class FrockForm extends StatefulWidget {
  ...
  FrockForm(
      ...
      this.sleevesLengthD});
  @override
  _FrockFormState createState() => _FrockFormState();
}
...
class _FrockFormState extends State<FrockForm> {
  @override
  void initState() {
    _updateAppbar();
    // play();
  ...
  uploadData() async {
    ...
    if (topMeasurement.docs.isNotEmpty) {
      ...
      Navigator.push(context, CupertinoPageRoute(builder: (context) {
        return MeasurementSwitcherFrock(
          bottomPrice: widget.bottomPrice,
          bottomId: widget.bottomId,
          sleevesAstar: sleevesAstar,
          damanPrice: widget.damanPrice,
          basicPrice: priceResult.data()['basicFrock'],
          premiumPrice: priceResult.data()['premiumFrock'],
    ...
    return ListView(
      ...
      children: [
        ...
        ListTile(
          ...
          title: Text(
              DemoLocalizations.of(context).getTranslatedValue("patch?_frock"),
              style: TextStyle(
                fontFamily: 'CodeProlight',
                color: Colors.black,
                fontSize: 18,
        ...
        Align(
          ...
          child: Padding(
            ...
            child: Text(
                DemoLocalizations.of(context)
                    .getTranslatedValue("notes_text_frock"),
                style: TextStyle(
                  fontFamily: 'CodeProlight',
                  color: Colors.black,
                  fontSize: 16,
